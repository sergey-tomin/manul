...
#
# Created: Thu Mar 30 04:16:22 2017
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.pb_update_orbit = QtGui.QPushButton(self.tab_3)
        self.pb_update_orbit.setMinimumSize(QtCore.QSize(0, 60))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.pb_update_orbit.setFont(font)
        self.pb_update_orbit.setStyleSheet(_fromUtf8("color: rgb(85, 255, 127);"))
        self.pb_update_orbit.setObjectName(_fromUtf8("pb_update_orbit"))
        self.horizontalLayout_2.addWidget(self.pb_update_orbit)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_update_orbit.setText(_translate("Form", "Update Orbit", None))
