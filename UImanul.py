...
#
# Created: Wed Mar 15 14:34:02 2017
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.w_cor = QtGui.QWidget(self.tab_3)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(self.w_cor.sizePolicy().hasHeightForWidth())
        self.w_cor.setSizePolicy(sizePolicy)
        self.w_cor.setMinimumSize(QtCore.QSize(400, 200))
        self.w_cor.setMaximumSize(QtCore.QSize(400, 16777215))
        self.w_cor.setObjectName(_fromUtf8("w_cor"))
        self.horizontalLayout_4.addWidget(self.w_cor)
        self.gridLayout_8.addLayout(self.horizontalLayout_4, 0, 0, 1, 1)
        self.horizontalLayout_2 = QtGui.QHBoxLayout()
        self.horizontalLayout_2.setObjectName(_fromUtf8("horizontalLayout_2"))
        self.pb_write_corrs = QtGui.QPushButton(self.tab_3)
        self.pb_write_corrs.setMinimumSize(QtCore.QSize(150, 60))
        font = QtGui.QFont()
        font.setPointSize(16)
        font.setBold(True)
        font.setWeight(75)
        self.pb_write_corrs.setFont(font)
        self.pb_write_corrs.setStyleSheet(_fromUtf8("color: rgb(85, 255, 127);"))
        self.pb_write_corrs.setObjectName(_fromUtf8("pb_write_corrs"))
        self.horizontalLayout_2.addWidget(self.pb_write_corrs)
        ...
        self.horizontalLayout_2.addWidget(self.pb_read_orbit)
        ...
        self.verticalLayout_3.addWidget(self.pb_update_3)
        self.pb_reset_3 = QtGui.QPushButton(self.frame_3)
        self.pb_reset_3.setEnabled(True)
        self.pb_reset_3.setMinimumSize(QtCore.QSize(0, 20))
        self.pb_reset_3.setSizeIncrement(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.pb_reset_3.setFont(font)
        self.pb_reset_3.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);"))
        self.pb_reset_3.setObjectName(_fromUtf8("pb_reset_3"))
        self.verticalLayout_3.addWidget(self.pb_reset_3)
        self.verticalLayout_4.addLayout(self.verticalLayout_3)
        self.horizontalLayout_2.addWidget(self.frame_3)
        self.gridLayout_8.addLayout(self.horizontalLayout_2, 6, 0, 1, 1)
        ...
        self.pb_reset_6 = QtGui.QPushButton(self.groupBox_2)
        self.pb_reset_6.setEnabled(True)
        self.pb_reset_6.setMinimumSize(QtCore.QSize(0, 20))
        self.pb_reset_6.setSizeIncrement(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.pb_reset_6.setFont(font)
        self.pb_reset_6.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);"))
        self.pb_reset_6.setObjectName(_fromUtf8("pb_reset_6"))
        self.gridLayout_3.addWidget(self.pb_reset_6, 3, 1, 1, 1)
        self.pb_uncheck = QtGui.QPushButton(self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.pb_uncheck, 4, 2, 1, 1)
        self.pb_update_5 = QtGui.QPushButton(self.groupBox_2)
        self.pb_update_5.setMinimumSize(QtCore.QSize(0, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.pb_update_5.setFont(font)
        self.pb_update_5.setObjectName(_fromUtf8("pb_update_5"))
        self.gridLayout_3.addWidget(self.pb_update_5, 3, 0, 1, 1)
        self.pb_check = QtGui.QPushButton(self.groupBox_2)
        ...
        self.gridLayout_3.addWidget(self.pb_check, 3, 2, 1, 1)
        self.pb_reset_7 = QtGui.QPushButton(self.groupBox_2)
        self.pb_reset_7.setEnabled(True)
        self.pb_reset_7.setMinimumSize(QtCore.QSize(0, 20))
        self.pb_reset_7.setSizeIncrement(QtCore.QSize(0, 0))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        self.pb_reset_7.setFont(font)
        self.pb_reset_7.setStyleSheet(_fromUtf8("color: rgb(255, 0, 0);"))
        self.pb_reset_7.setObjectName(_fromUtf8("pb_reset_7"))
        self.gridLayout_3.addWidget(self.pb_reset_7, 4, 1, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_write_corrs.setText(_translate("Form", "Write to Quads", None))
        ...
        self.pb_reset_6.setText(_translate("Form", "Correct Orbit", None))
        self.pb_uncheck.setText(_translate("Form", "Uncheck", None))
        self.pb_update_5.setText(_translate("Form", "Calculate RM", None))
        self.pb_check.setText(_translate("Form", "Check", None))
        self.pb_reset_7.setText(_translate("Form", "Calculate Misalignment", None))
