...
from xfel_l3_mode_B import *
from xfel_sase1_mad import *
from xfel_sase3_mad import *
...
cell = cell_i1 + cell_l1 + cell_l2 + cell_l3 + cell_sase1 + cell_t4 + cell_sase3
...
lat = MagneticLattice(cell, stop=ensub_2583_t4)
tws2 = twiss(lat, tws0)
print(tws2[-1])
