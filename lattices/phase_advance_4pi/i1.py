...
# cavity 
c_a1_1_1_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.1.I1')
c_a1_1_2_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.2.I1')
c_a1_1_3_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.3.I1')
c_a1_1_4_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.4.I1')
c_a1_1_5_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.5.I1')
c_a1_1_6_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.6.I1')
c_a1_1_7_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.7.I1')
c_a1_1_8_i1 = Cavity(l=1.0377, v=0.018124987050000003, freq=1300000.0*1e3, phi=0.0, eid='C.A1.1.8.I1')
c3_ah1_1_1_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.1.I1')
c3_ah1_1_2_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.2.I1')
c3_ah1_1_3_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.3.I1')
c3_ah1_1_4_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.4.I1')
c3_ah1_1_5_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.5.I1')
c3_ah1_1_6_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.6.I1')
c3_ah1_1_7_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.7.I1')
c3_ah1_1_8_i1 = Cavity(l=0.346, v=0.0024999884, freq=3900000.0*1e3, phi=180.0, eid='C3.AH1.1.8.I1')
