...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout.addWidget(self.plot_widget, 1, 0, 1, 5)
    ...
    def retranslateUi(self, Form):
        ...
        self.pb_use_it.setText(_translate("Form", "Use It"))
