...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.gridLayout_8.addWidget(self.sb_beta, 3, 2, 1, 1)
        self.combo_solver = QtWidgets.QComboBox(self.groupBox_3)
        self.combo_solver.setObjectName("combo_solver")
        self.combo_solver.addItem("")
        self.combo_solver.addItem("")
        self.gridLayout_8.addWidget(self.combo_solver, 0, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.sb_epsilon_x, 1, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.sb_epsilon_y, 2, 2, 1, 1)
        self.gridLayout_7.addLayout(self.gridLayout_8, 0, 1, 1, 1)
        self.verticalLayout.addWidget(self.groupBox_3)
        self.gbox_micado = QtWidgets.QGroupBox(self.tab_6)
        self.gbox_micado.setObjectName("gbox_micado")
        self.gridLayout_22 = QtWidgets.QGridLayout(self.gbox_micado)
        self.gridLayout_22.setObjectName("gridLayout_22")
        self.gridLayout_21 = QtWidgets.QGridLayout()
        self.gridLayout_21.setObjectName("gridLayout_21")
        self.sb_epsilon_ksi = QtWidgets.QDoubleSpinBox(self.gbox_micado)
        self.sb_epsilon_ksi.setLocale(QtCore.QLocale(QtCore.QLocale.English, QtCore.QLocale.UnitedStates))
        self.sb_epsilon_ksi.setDecimals(2)
        self.sb_epsilon_ksi.setMaximum(1000.0)
        self.sb_epsilon_ksi.setSingleStep(1.0)
        self.sb_epsilon_ksi.setProperty("value", 10.0)
        self.sb_epsilon_ksi.setObjectName("sb_epsilon_ksi")
        self.gridLayout_21.addWidget(self.sb_epsilon_ksi, 0, 1, 1, 1)
        self.label_21 = QtWidgets.QLabel(self.gbox_micado)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        ...
        self.gridLayout_10.addWidget(self.cb_style_def, 2, 1, 1, 1)
        ...
        self.chb_show_extension = QtWidgets.QCheckBox(self.tab_5)
        self.chb_show_extension.setObjectName("chb_show_extension")
        self.gridLayout_10.addWidget(self.chb_show_extension, 1, 0, 1, 1)
        ...
        self.cb_activate_freezing = QtWidgets.QCheckBox(self.tab_7)
        self.cb_activate_freezing.setObjectName("cb_activate_freezing")
        self.gridLayout_20.addWidget(self.cb_activate_freezing, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Form):
        ...
        self.combo_solver.setItemText(0, _translate("Form", "SVD"))
        self.combo_solver.setItemText(1, _translate("Form", "MICADO"))
        ...
        self.gbox_micado.setTitle(_translate("Form", "MICADO"))
        self.label_21.setText(_translate("Form", "ksi - iteration is stopped when the peak-to-peak amplitude of the residual vector is <"))
        self.label_22.setText(_translate("Form", "um"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_6), _translate("Form", "Solver"))
        ...
        self.chb_show_extension.setText(_translate("Form", "Extending panel by default"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_5), _translate("Form", "Appearance"))
        self.cb_activate_freezing.setText(_translate("Form", "Activate BPM freeze GUI"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tab_7), _translate("Form", "Danger Area"))
